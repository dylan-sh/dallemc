...
public class ImageGeneration {
     ...
     * generateURL() calls the api and generates the image. it does so by using a python script located in the dallemc folder generated by ConfigParser
     * Generated images are saved to the input of the Pixelator plugin folder
    ...
    public String generateImage() throws IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder("C:\\Users\\dylan\\AppData\\Local\\Programs\\Python\\Python311\\python.exe", pythonScript, suggestion, apiKey); //you will have to change this unless i get around to fixing it
